                ...
                <div class="author-box author-box-vertical">
                    <div class="author-box__image">
                        <div class="author-avatar">
                            <img alt="designUTD" src="<?php echo $placeholder; ?>" data-src="<?php echo $admin_author; ?>" class="avatar avatar-150 photo avatar photo" height="150" width="150" loading="lazy">
                        </div>
                    </div>
                    <div class="author-box__text">
                        <div class="author-name meta-font">
                            <a class="entry-author__name" rel="author" title="designUTD" href="./author.html">Techpd</a>
                        </div>
                        ...
                        <div class="author-info">
                            <ul class="list-unstyled list-horizontal list-space-sm">
                                <li><a href="mailto:techpd@blog.com"><i class="mdicon mdicon-mail_outline"></i><span class="sr-only">e-mail</span></a></li>
                                <li><a href="https://www.linkedin.com/in/prahlad-dixit-4022841b6/" target="_blank"><i class="mdicon mdicon-linkedin"></i><span class="sr-only">Website</span></a></li>
                                <li><a href="https://github.com/techpd" target="_blank"><i class="mdicon mdicon-public"></i><span class="sr-only">Website</span></a></li>
                                <li><a href="https://www.facebook.com/pawan.dixit.5682" target="_blank"><i class="mdicon mdicon-facebook"></i><span class="sr-only">Facebook</span></a></li>
                                <li><a href="https://www.instagram.com/pawandixitg/" target="_blank"><i class="mdicon mdicon-instagram"></i><span class="sr-only">Facebook</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
