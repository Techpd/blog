...
if (have_rows('page_builder')) {
    while (have_rows('page_builder')) {
        ...
        if (get_row_layout('slide_loop_on_off')) {
            $slide_loop_toggle = get_sub_field('button');
            ...
            <div class="atbs-block atbs-block--fullwidth atbs-featured-module-1">
                <div class="atbs-block__inner">
                    ...
                    <div class="section-sub">
                        <div class="owl-carousel js-atbs-carousel-4i30m atbs-carousel dots-circle dots-white" data-carousel-loop="<?php echo $slide_loop_toggle; ?>">
                            <?php
                            $sticky = get_option('sticky_posts');
